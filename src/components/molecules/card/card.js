...
export default class Card extends Component {
    ...
    onPress = () => {
        this.props.onClick && this.props.onClick({ color: this.props.color, suite: this.props.suite, rank: this.props.rank });
    };
    ...
    render() {
        ...
        return (
            <div onTouchTap={this.onPress} style={styles.card}>
                <div style={this.props.color == DECK_COLORS.red ? styles.headerRed : styles.headerBlack}>
                    <div style={styles.value}>
                        ...
                        <div style={styles.iconContainer}>
                            <Text style={this.props.color == DECK_COLORS.red ? styles.suiteRed : styles.suiteBlack}>
                                {this.getSuite()}
                            </Text>
                        </div>
                    </div>
